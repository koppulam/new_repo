	...
	var Slider = function (_React$Component) {
	  ...
	  Slider.prototype.render = function render() {
	    ...
	    if (settings.noRightPadding) {
	      if (settings.infinite && (undefined) !== "production") {
	        console.warn("infinite should be false when noRightPadding is true, you're using " + settings.infinite);
	      }
	...
	var InnerSlider = exports.InnerSlider = function (_React$Component) {
	  ...
	  function InnerSlider(props) {
	    ...
	    _this.componentDidMount = function () {
	      window.addEventListener('touchstart', _this.touchStart);
	      window.addEventListener('touchmove', _this.preventTouch, { passive: false });
	      ...
	      Array.prototype.forEach.call(document.querySelectorAll('.slick-slide'), function (slide) {
	        ...
	        if (slide && _this.props.accessibility) {
	          var selectableEls = slide.querySelectorAll('video, select, textarea, area, a, input:not([type=hidden]), button, div[tabindex="0"]');

	          if (selectableEls.length > 0) {
	            selectableEls[selectableEls.length - 1].addEventListener('focus', _this.onCustomSlideFocus);
	            selectableEls[selectableEls.length - 1].addEventListener('blur', _this.onCustomSlideBlur);
	          }
	        }
	      });
	    ...
	    _this.componentWillUnmount = function () {
	      window.removeEventListener('touchstart', _this.touchStart);
	      window.removeEventListener('touchmove', _this.preventTouch, { passive: false });
	    ...
	    _this.componentDidUpdate = function () {
	      ...
	      if (_this.props.variableWidth === true && _this.track && _this.props.noRightPadding === true) {
	        var trackElem = _reactDom2.default.findDOMNode(_this.track);
	        var listWidth = Math.ceil((0, _innerSliderUtils.getWidth)(_reactDom2.default.findDOMNode(_this.list)));
	        var widthOfAllChildren = 0;

	        for (var slide = 0; slide < trackElem.childNodes.length; slide++) {
	    ...
	    _this.slideHandler = function (index) {
	      ...
	      var _this$props = _this.props,
	          ...
	          finalPadding = _this$props.finalPadding;
	    ...
	    _this.swipeEnd = function (e) {
	      ...
	      _this.setState(state);
	      _this.slideHandler(triggerSlideHandler === undefined ? _this.state.slideCount : triggerSlideHandler);
	      if (_this.props.verticalSwiping) {
	    ...
	    _this.closest = function (el, selector, stopSelector) {
	      var retval = null;
	      while (el) {
	        if (_this.hasClass(el, selector)) {
	          retval = el;
	          break;
	        } else if (stopSelector && _this.hasClass(el, stopSelector)) {
	          break;
	        }
	        el = el.parentElement;
	      }
	    ...
	    _this.onCustomSlideFocus = function (event) {
	      // console.log('focus');
	      // console.log(event);
	      var slideParent = _this.closest(event.target, 'slick-slide');
	      _this.slickGoTo(slideParent.dataset.index);
	    };

	    _this.onCustomSlideBlur = function (event) {
	      // console.log('blur');
	      // console.log(event);
	    };
	    ...
	    _this.render = function () {
	      ...
	      var spec = _extends({}, _this.props, _this.state, { trackRef: _this.track });
	      var trackProps = (0, _innerSliderUtils.extractObject)(spec, ['fade', 'cssEase', 'speed', 'infinite', 'centerMode', 'focusOnSelect', 'currentSlide', 'lazyLoad', 'lazyLoadedList', 'rtl', 'slideWidth', 'slideHeight', 'listHeight', 'vertical', 'slidesToShow', 'slidesToScroll', 'slideCount', 'trackStyle', 'variableWidth', 'unslick', 'accessibility', 'noRightPadding', 'centerPadding']);
	      ...
	      if (_this.props.noRightPadding) {
	        unslick = _this.unslick;
	      } else {
	        unslick = _this.props.unslick;
	      }
	  ...
	  InnerSlider.prototype.touchStart = function touchStart(e) {
	    this.firstClientX = e.touches[0].clientX;
	    this.firstClientY = e.touches[0].clientY;
	  };

	  InnerSlider.prototype.preventTouch = function preventTouch(e) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var canGoNext = exports.canGoNext = function canGoNext(spec) {
	  ...
	  if (spec.variableWidth === true && spec.trackRef && spec.noRightPadding === true) {
	    var trackElem = _reactDom2.default.findDOMNode(spec.trackRef);
	    var targetSlideIndex = spec.currentSlide + getPreClones(spec);
	    var targetSlide = trackElem && trackElem.childNodes[targetSlideIndex];
	    var targetLeft = targetSlide ? targetSlide.offsetLeft * -1 : 0;
	    var widthUntilListRightEnd = 0;

	    for (var slide = targetSlideIndex; slide < trackElem.childNodes.length; slide++) {
	      widthUntilListRightEnd += trackElem && trackElem.children[slide] && trackElem.children[slide].offsetWidth;
	    }
	...
	var slideHandler = exports.slideHandler = function slideHandler(spec) {
	  var waitForAnimate = spec.waitForAnimate,
	      ...
	      useCSS = spec.useCSS,
	      finalPadding = spec.finalPadding;
	  ...
	  if (fade) {
	    ...
	    var widthofOne = finalLeft * -1 / (slideCount - 1);
	...
	var renderSlides = function renderSlides(spec) {
	  ...
	  _react2.default.Children.forEach(spec.children, function (elem, index) {
	    ...
	    slides.push(_react2.default.cloneElement(child, {
	      ...
	      tabIndex: '-1',
	      'aria-hidden': spec.accessibility && spec.enableAriaHidden ? !slideClasses['slick-active'] : undefined,
