 ...
 * @module sticky-nav
 * @version 1.0.0
 * @since Fri May 25 2018
 */

// dependencies
import './sticky-nav.hbs';
 ...
 * @type {string}
 */
export const componentReference = 'app-js__sticky-nav';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'sticky-nav';
 ...
 */
function createStickynavInstance() {
    /**
     * Component instance.
     * @type {Object}
     */
...
registerComponent(componentReference, createStickynavInstance);
