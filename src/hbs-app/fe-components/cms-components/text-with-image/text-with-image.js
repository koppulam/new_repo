...
// dependencies
import './text-with-image.hbs';
import './text-with-image.scss';
 ...
 * @type {string}
 */
export const componentReference = 'app-js__text-with-image';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'text-with-image';
 ...
 */
function createTextwithimageInstance() {
    /**
     * Component instance.
     * @type {Object}
     */
...
registerComponent(componentReference, createTextwithimageInstance);
