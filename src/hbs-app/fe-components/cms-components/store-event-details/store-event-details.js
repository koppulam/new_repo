/**
 * @module store-event-details
 * @version 1.0.0
 * @since Wed Aug 08 2018
 */

// dependencies
import './store-event-details.hbs';
import './store-event-details.scss';
 ...
 * @type {string}
 */
export const componentReference = 'app-js__store-event-details';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'store-event-details';
 ...
 */
function createStoreeventdetailsInstance() {
    /**
     * Component instance.
     * @type {Object}
     */
    ...
    function initDOMReferences() {
        ...
        $reservationBtns = $element.find('.btn');
...
registerComponent(componentReference, createStoreeventdetailsInstance);
