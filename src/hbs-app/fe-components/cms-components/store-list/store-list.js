 ...
 * @type {string}
 */
export const componentReference = 'app-js__store-list';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'store-list';
 ...
 */
function createStorelistInstance() {
    /**
     * Component instance.
     * @type {Object}
     */
    ...
    function addListeners() {
        ...
        // TODO: Trigger the custom event on click from exposed page
        $('.open_pdp').click(() => {
            const customEvent = new CustomEvent('OPEN_MINI_PDP', {
                detail: {
                    skuId: '25508335',
                    groupId: 'GRP02985'
                }
...
registerComponent(componentReference, createStorelistInstance);
