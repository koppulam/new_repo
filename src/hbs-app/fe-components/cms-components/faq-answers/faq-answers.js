...
// dependencies
import './faq-answers.hbs';
import './faq-answers.scss';
 ...
 * @type {string}
 */
export const componentReference = 'app-js__faq-answers';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'faq-answers';
 ...
 */
function createFaqanswersInstance() {
    /**
     * Component instance.
     * @type {Object}
     */
...
registerComponent(componentReference, createFaqanswersInstance);
