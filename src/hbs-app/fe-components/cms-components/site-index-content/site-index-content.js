 ...
 * @module site-index
 * @version 1.0.0
 * @since Thursday Oct 11 2018
 */

// dependencies
import './site-index-content.hbs';
import './site-index-content.scss';
 ...
 * @type {string}
 */
export const componentReference = 'app-js__site-index';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'site-index';
 ...
 */
function createSiteIndexInstance() {
    /**
     * Component instance.
     * @type {Object}
     */
...
registerComponent(componentReference, createSiteIndexInstance);
