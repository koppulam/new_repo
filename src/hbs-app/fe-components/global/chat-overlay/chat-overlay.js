 ...
 * @module chat-overlay
 * @version 1.0.0
 * @since Thu Apr 25 2019
 */

// dependencies
import './chat-overlay.hbs';
import './chat-overlay.scss';
 ...
 * @type {string}
 */
export const componentReference = 'app-js__chat-overlay';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'chat-overlay';
 ...
 */
function createChatoverlayInstance() {
    /**
     * Component instance.
     * @type {Object}
     */
...
registerComponent(componentReference, createChatoverlayInstance);
