 ...
 * @module breadcrumb
 * @version 1.0.0
 * @since Tue May 29 2018
 */

// dependencies
import './breadcrumb.hbs';
 ...
 * @type {string}
 */
export const componentReference = 'app-js__breadcrumb';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'breadcrumb';
 ...
 */
function createBreadcrumbInstance() {
    /**
     * Component instance.
     * @type {Object}
     */
    ...
    /**
     * Logic to run when breacrumb in moved
     * @param {event} event object
     * @returns {void}
     */
    function onTouchMove(event) {
        const isBreadCrumb = $(instance.element).closest('.breadcrumb').length;
    ...
    function addListeners() {
        ...
        instance.addEventListener('touchmove', onTouchMove);
...
registerComponent(componentReference, createBreadcrumbInstance);
