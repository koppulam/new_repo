 ...
 * @type {string}
 */
export const componentReference = 'app-js__product-tile';

/**
 * The style definition of the component.
 * @type {string}
 */
export const styleDefinition = 'product-tile';
 ...
 */
function createProducttileInstance() {
    /**
     * Component instance.
     * @type {Object}
     */
...
registerComponent(componentReference, createProducttileInstance);
